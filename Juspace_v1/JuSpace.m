...
savefig(gcf,fullfile(dir_save,['Bar_' name_save file_part '_' time_now '.fig']));
print(gcf,fullfile(dir_save,['Bar_' name_save file_part '_' time_now '.png']),'-dpng','-r300');
%-----------------------
...
%     n_color = 1./(n_draw+1);
    ...
    figure('Position',[400 0 900 n_rows.*300]);
    subplot(n_rows,3,1);
    n_draw = 31;
...
%     suplabel('Data Modality','y','FontSize',20);
    savefig(gcf,fullfile(dir_save,['Line_' name_save file_part '_' time_now '.fig']));
    print(gcf,fullfile(dir_save,['Line_' name_save file_part '_' time_now '.png']),'-dpng','-r300');
end
%-----------------------
