...
PET and SPECT data sources are listed in [`Sources_templates_release.md`](JuSpace_v2/Sources_templates_release.md). Please cite all sources corresponding to respective PET or SPECT maps. Please note that some of the PET maps are released under a different license as indicated in the .txt file.
...
- `stats.res_ind`: Individual Fisher's z-transformed correlation coefficients / regression coefficients
